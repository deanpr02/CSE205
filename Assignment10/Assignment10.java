...
// Description: This class will create a menu that will be able to add flights to a queue along with determining which flight is in the
// queue first, removing flights from the queue, and listing all the flights in the queue
